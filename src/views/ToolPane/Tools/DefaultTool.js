...
export default class DataTool extends Component {
    ...
    beforeUpload = (file) => {
        ...
        //打印日志
        HttpUtil.post(ApiUtil.API_COLOR_LOG, 'upLoadData')
            .then(re=>{         
            })
            .catch(error=>{
            ...
            display:'flex',flexDirection:'column',flex:'1'
                ...
                /> */}
                 {/* <MappingPanel currentFields={carsSchema} channels={this.props.channels}  {...this.props} /> */}
                    <div style={{ height: '283px', padding:'10px',marginTop:'-20px'}}>
                
                        {/* <div className='header'>Fields</div> */}
                        <Divider className='headerDivder' orientation="left">Fields</Divider>
