...
const draw = (props) => {
    ...
    projection.fitSize([width, height], mapdata.geoData) //地图根据屏幕自适配 
    ...
    console.log('colorList-map',colorList)
   ...
   if(textcolor == 'rgb(64,64,64)'){
    ...
    svg.selectAll('path')
        ...
        .attr('fill', function (d, i) {
            ...
            if (!value) return 'rgb(244, 244, 244)'//'rgb(227, 228, 229)' //不存在数据的国家，显示灰色
            //设定各省份的填充色
            let color;
