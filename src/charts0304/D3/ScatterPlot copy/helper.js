...
const getAverageRows = (rawData, encoding) => {
  ...
  let data = calculateData.map(function (d, i) {
      d.values.forEach(d => {
          ...
          sumData[i] += parseInt(d[encoding.y.field]) 
      })
      let sumRows = Object.assign({}, d.values[0])
      console.log('sver-sactter',sumData[i])
      
      sumRows[encoding.y.field] = sumData[i];
      console.log('sver-sactter',sumRows[encoding.y.field])
      return sumRows;
  });
  return data;
}
...
export {getSeries, getLeastSquares,getAverageRows, getWidth}