...
export default class D3Chart extends Component {
    ...
    renderChart = () => {
        ...
        console.log('render-props', newProps);
        // this.setState({
    ...
    render() {
        console.log('this.props.onCanvas',)
        if (this.props.onCanvas) {
            console.log('this.props.onCanvas image',)
            // return 
        //     <Portal><input
        //     style={{
        //       position: 'absolute',
        ...
        //   /></Portal>;
            ...
            console.log('this.props.onCanvas iddd')
