...
export default class configure extends Component {
    ...
    render() {
        ...
        animation.spec.category1 = animation.spec.category1?animation.spec.category1:categories[0];
        animation.spec.category2 = animation.spec.category2?animation.spec.category2:categories[1];
        return (
            <div>
                <Row  style={{ height: 50 }}>
                    <Col span={6}><h3 style={{ marginTop: 6 }}>Value1:</h3></Col>
                    <Col span={9}>
                        <Select value={category1} style={{ width: 120, marginTop: 4 }} onChange={this.handleCategory1Change}>
                    ...
                    <Col span={5}>
                        <Button size={'small'} style={{ marginTop: 8 }} onClick={() => this.props.selectChartElement(true, {type: 'value', key: 'category1'})}>Select</Button>
                    </Col>
                </Row>
                <Row  style={{ height: 50 }}>
                    <Col span={6}><h3 style={{ marginTop: 6 }}>Value2:</h3></Col>
                    <Col span={9}>
                        <Select value={category2} style={{ width: 120, marginTop: 4 }} onChange={this.handleCategory2Change}>
                            {categories.map((category) => <Option key={category} value={category}>{category}</Option>)}
                        </Select>
                    </Col>
                    <Col span={4}>
                    ...
                    <Col span={5}>
                        <Button size={'small'} style={{ marginTop: 8 }} onClick={() => this.props.selectChartElement(true, {type: 'value', key: 'category2'})}>Select</Button>
                    </Col>
                </Row>
                <Row style={{ height: 50 }}> 
